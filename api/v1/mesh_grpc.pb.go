...
type MeshClient interface {
	...
	// gateway列表
	GetGatewayList(ctx context.Context, in *GetGatewayOption, opts ...grpc.CallOption) (*GatewayList, error)
	// Create Gateway
...
func (c *meshClient) CheckInfo(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/cratos.service.v1.Mesh/CheckInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meshClient) GetGatewayList(ctx context.Context, in *GetGatewayOption, opts ...grpc.CallOption) (*GatewayList, error) {
	out := new(GatewayList)
	err := c.cc.Invoke(ctx, "/cratos.service.v1.Mesh/GetGatewayList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meshClient) CreateGateway(ctx context.Context, in *Gateway, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/cratos.service.v1.Mesh/CreateGateway", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMeshServer) GetGatewayList(context.Context, *GetGatewayOption) (*GatewayList, error) {
...
func _Mesh_CheckInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cratos.service.v1.Mesh/CheckInfo",
	}
...
func _Mesh_GetGatewayList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cratos.service.v1.Mesh/GetGatewayList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeshServer).GetGatewayList(ctx, req.(*GetGatewayOption))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Mesh_CreateGateway_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cratos.service.v1.Mesh/CreateGateway",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
