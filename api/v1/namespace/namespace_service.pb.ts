...
export async function Get(params: CratosApiV1Namespace.GetKind, options?: Options) {
	return request<CratosApiV1Namespace.Namespace>(APIService + '/cratos.api.v1.Namespace/Get', {
    	method: 'GET',
    	params: {...params},
    	...(options || {}),
	});
...
/** Create  创建 Namespace /api */
export async function Create(params: CratosApiV1Namespace.Namespace, options?: Options) {
...
/** Update  更新 Namespace /api */
export async function Update(params: CratosApiV1Namespace.Namespace, options?: Options) {
