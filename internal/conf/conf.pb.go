...
type Data struct {
	...
	Istio    *Data_Istio    `protobuf:"bytes,2,opt,name=istio,proto3" json:"istio,omitempty"`
	Kube     *Data_Kube     `protobuf:"bytes,3,opt,name=kube,proto3" json:"kube,omitempty"`
}
...
func (x *Data) GetIstio() *Data_Istio {
	if x != nil {
		return x.Istio
	}
	return nil
...
func (x *Data_Istio) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Istio) ProtoMessage() {}

func (x *Data_Istio) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Istio.ProtoReflect.Descriptor instead.
func (*Data_Istio) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Data_Istio) GetConfig() string {
	if x != nil {
		return x.Config
	}
	return ""
...
func (x *Data_Kube) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Kube) ProtoMessage() {}

func (x *Data_Kube) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Kube.ProtoReflect.Descriptor instead.
func (*Data_Kube) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Data_Kube) GetConfig() string {
	if x != nil {
		return x.Config
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0x93, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x3b, 0x63, 0x6f, 0x6e, 0x66,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Istio)(nil),          // 5: kratos.api.Data.Istio
	(*Data_Kube)(nil),           // 6: kratos.api.Data.Kube
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	5, // 5: kratos.api.Data.istio:type_name -> kratos.api.Data.Istio
	6, // 6: kratos.api.Data.kube:type_name -> kratos.api.Data.Kube
